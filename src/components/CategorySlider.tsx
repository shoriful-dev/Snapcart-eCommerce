...
const categories = [
  ...
  { id: 8, name: 'Household Esentials', icon: Home, color: 'bg-lime-100' },
  ...
  return (
    ...
    >
      ...
      {showLeft && (
        <button
          onClick={() => scroll('left')}
          className="absolute left-0 top-1/2 z-10 bg-white shadow-lg hover:bg-green-100 rounded-full w-10 h-10 flex items-center justify-center transition-all"
        >
      ...
      {showRight && (
        <button
          ...
          className="absolute right-0 top-1/2 z-10 bg-white shadow-lg hover:bg-green-100 rounded-full w-10 h-10 flex items-center justify-center transition-all"
        >
